...
var _dispatchRequest = __webpack_require__(6);
...
var types = ['delete', 'get', 'head', 'options', 'post', 'put', 'patch'];
function Request3(instanceConfig) {
  this.defaults = instanceConfig;
}

Request3.prototype.request = function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _dispatchRequest2.default)(Object.assign({}, this.defaults, options));
...
types.forEach(function (type) {
  Request3.prototype[type] = function () {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return undefined.request(Object.assign({}, options, { type: type }));
...
function dispatchRequest(options) {
  var adapter = adapters[options.adapeter || 'ajax'];
  // todo adaper具体实现
  // 处理 cache
}
...
var request3 = new _Request2.default(_default2.default.defaultOptions);
